...
int main(int argc, char** argv) {
    ...
    try {
        ...
        nlohmann::json output = {
            ...
            {"effective_radio_offset_seconds", seconds(
                session.alignment.radio_anchor_us + session.alignment.fine_correction_us)},
            {"trigger_sign", session.alignment.trigger_sign},
            {"steering_sign", session.alignment.steering_sign},
